...
interface TaskCardProps {
  ...
  theme:
    'blue' | 'purple' | 'orange' | 'green' | 'pink' | 'teal' | 'red' | 'indigo' | 'mint' | 'amber';
  isActive?: boolean;
  isPaused?: boolean;
  isPinned?: boolean;
  onPress?: () => void;
      ...
      <View style={styles.bottomRow}>
        <View style={styles.textContainer}>
          <View style={styles.titleRow}>
            ...
            <Text style={[styles.title, { color: currentTheme.fg }]} numberOfLines={1}>
              {title}
            </Text>
          </View>
        ...
        <View style={styles.playButtonContainer}>
          ...
          >
            <Ionicons
              ...
              style={(!isActive || isPaused) && { marginLeft: 2 }}
            />
          </TouchableOpacity>
        </View>
      </View>
